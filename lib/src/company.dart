...
class FakeCompany {
  ...
  static const List<String> _companyNames = [
    'Acme Corp', 'Tech Solutions', 'Global Enterprises', 'Innovate Ltd', 'Prime Industries'
  ];
  ...
  static const List<String> _slogans = [
    'Innovating the future', 'Quality first', 'Your success is our mission', 'Leading with excellence'
  ];
